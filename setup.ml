...
(* OASIS_START *)
(* DO NOT EDIT (digest: d2378bdee1efc423bbb2c8403b573c9c) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          synopsis =
            "DPRLE decision procedure for systems of equations that consist of\nregular languages, concatenation, and grounded subset constraints.";
          description = None;
          categories = [];
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "dprle.ml"; });
               Doc
                 ({
                     cs_name = "doc";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.3.0";
     oasis_digest =
       Some "\243\2290\250e\1317\192\177)\011\147\000\250\254\208";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
